...
export function renderSpiral(container: HTMLElement, worlds: World[]): void {
...
export function renderWorldMap(container: HTMLElement, world: World): void {
    // world map img
...
export function renderArea(container: HTMLElement, area: Area): void {
    // area img
